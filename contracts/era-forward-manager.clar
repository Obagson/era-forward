;; era-forward-manager.clar
;; Era Forward - Shared Financial Commitment Platform

;; This contract manages shared financial commitments, expenses, and settlements on the Stacks blockchain.
;; It allows participants to create shared financial groups, track recurring and one-time expenses, 
;; maintain running balances between members, and facilitate transparent payment settlements.
